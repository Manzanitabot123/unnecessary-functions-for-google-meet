...
if (style.styleSheet){ style.styleSheet.cssText = css;} else { style.appendChild(document.createTextNode(css)) }; for(x=0; x<document.querySelectorAll("[class='qg7mD r6DyN xm86Be JBY0Kc eXUaib']").length; x++) { document.querySelectorAll("[class='qg7mD r6DyN xm86Be JBY0Kc eXUaib']")[x].style.animation = "rotation 0.7s infinite linear"; }
